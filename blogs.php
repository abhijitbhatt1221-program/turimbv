...
<head>
  ...
  <title>Travel Blogs | TOURIM</title>
  <meta name="description" content="TOURIM travel guides and useful planning blogs." />
...
<section class="page-hero">
  <div class="container"><div class="breadcrumb"><a href="index.html">Home</a><span>›</span><span>Blogs</span></div><h1>Travel guides and planning ideas</h1><p>Helpful content for choosing destinations, hotels, routes, seasons and budget-friendly tour plans.</p><div class="page-toolbar"><input id="pageSearch" placeholder="Search blogs by name, destination or category"></div></div>
</section>
