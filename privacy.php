...
<head>
  ...
  <title>Privacy Policy | TOURIM</title>
  <meta name="description" content="TOURIM privacy policy." />
...
<section class="page-hero"><div class="container"><h1>Privacy Policy</h1><p>TOURIM uses enquiry data only to respond to travel planning requests and improve customer service.</p></div></section><section class="page-section"><div class="container panel article"><h2>Information collected</h2><p>Name, phone, email, travel date, destination, guest count, budget and message details submitted through enquiry forms.</p><h2>Usage</h2><p>Data is used for quotation, follow-up, booking support and internal analytics. TOURIM does not sell customer data.</p><h2>Contact</h2><p>Email <span data-email>owner.tourim@gmail.com</span> for privacy-related requests.</p></div></section>
