<?php
/*
Template Name: TOURIM Destinations
*/
...
<head>
  ...
  <title>Destinations | TOURIM</title>
  <meta name="description" content="Explore TOURIM travel destinations." />
...
<section class="page-hero">
  <div class="container"><div class="breadcrumb"><a href="index.html">Home</a><span>›</span><span>Destinations</span></div><h1>Explore destinations with TOURIM</h1><p>Choose from hill stations, beaches, islands, international cities and nature routes with expert guidance.</p><div class="page-toolbar"><input id="pageSearch" placeholder="Search destinations by name, destination or category"></div></div>
</section>
