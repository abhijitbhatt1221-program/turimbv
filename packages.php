...
<head>
  ...
  <title>Packages | TOURIM</title>
  <meta name="description" content="Browse TOURIM domestic and international travel packages." />
...
<section class="page-hero">
  <div class="container"><div class="breadcrumb"><a href="index.html">Home</a><span>›</span><span>Packages</span></div><h1>Tour packages for every traveller</h1><p>Find family holidays, group tours, honeymoon journeys, hill escapes, beaches and international tours.</p><div class="page-toolbar"><input id="pageSearch" placeholder="Search packages by name, destination or category"></div></div>
</section>
