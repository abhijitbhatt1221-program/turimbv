...
<head>
  ...
  <title>About | TOURIM</title>
  <meta name="description" content="About TOURIM travel agency." />
...
<section class="page-hero"><div class="container"><div class="breadcrumb"><a href="index.html">Home</a><span>›</span><span>About</span></div><h1>About TOURIM</h1><p>TOURIM is a customised travel agency focused on budget-friendly, well-planned domestic and international tour experiences.</p></div></section>
<section class="page-section"><div class="container section-split"><div class="panel"><span class="badge orange">Our Promise</span><h2>Travel on your day, on your budget</h2><p>TOURIM helps travellers plan comfortable holidays with transparent inclusions, curated hotels, destination guidance and direct support. The brand focuses on personalised packages instead of one-size-fits-all trips.</p><ul class="feature-list"><li>Domestic and international customised packages</li><li>Family, honeymoon, group and corporate tours</li><li>Clear package inclusion and exclusion support</li><li>Quick WhatsApp and phone assistance</li></ul></div><div class="contact-card"><h2>Contact TOURIM</h2><p><b>Phone:</b> <span data-phone>7384732179</span><br><b>Email:</b> <span data-email>owner.tourim@gmail.com</span><br><b>Address:</b> <span data-address>Ashokenagar Kachua More, North 24 Parganas, 743272</span></p><a class="btn primary" href="contact.html">Plan a trip</a></div></div></section>
<section class="page-section"><div class="container"><div class="section-title"><div><span class="badge purple">Customer Voice</span><h2>What travellers say</h2></div></div><div class="cards-grid" data-testimonials></div></div></section>
